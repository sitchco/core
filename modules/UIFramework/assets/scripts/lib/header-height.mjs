...
export function registerHeaderHeightActions() {
    ...
    addFilter('header-height', () => {
        return header?.offsetHeight || 0;
    }, 5);

    addFilter('header-offset', () => {
        if (window.scrollY === 0) {
    ...
    const scrollTargetFallback = debounce(event => {
        ...
        window.scrollTo({ top: targetOffset - applyFilters('header-height'), behavior: 'smooth' });
    }, isiOS ? 300 : 0);
